...
export default function Filter({
	...
	return (
		<button
			type="button"
			className={cn(
				'inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-semibold tracking-wide transition-all duration-200 cursor-pointer shadow-2xs',
				isActive
					? 'bg-zinc-950 text-white shadow-xs dark:bg-white dark:text-zinc-950'
					: 'bg-white text-zinc-600 border border-zinc-200 hover:border-zinc-300 hover:bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-200',
			)}
			onClick={() => {
