	...
	return (
		<>
			<article {...moduleAttributes(props)} className="section">
				<div className="relative rounded-xl bg-white py-4 lg:py-8">
					<header className="relative pb-4 text-center lg:pb-8">
						{/* <Img
					...
					/> */}
						...
						<div className="relative mx-auto max-w-5xl space-y-4">
							...
							<div className="gap-x-lh flex flex-wrap items-center justify-center gap-y-1 text-xs lg:text-sm">
					...
					<section className="gap-lh flex max-lg:p-2 max-md:flex-col md:items-start">
						{/* {(toc === 'left' || toc === 'right') && (
						<TableOfContents
						...
						<div
							className={cn(
								css.body,
								'prose mx-auto grid w-full max-w-4xl max-md:text-sm',
							)}
						>
							<PortableText
								value={post.content ?? []}
