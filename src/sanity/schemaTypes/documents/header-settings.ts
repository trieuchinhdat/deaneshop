...
export default defineType({
	...
	fields: [
		...
		defineField({
			...
			description: 'Visual appearance variant for the category dropdown button in Layout 2',
			type: 'string',
			options: {
				list: [
					{ title: 'Secondary Soft (Tonal Background - Default)', value: 'action-secondary' },
					{ title: 'Primary Solid (Brand Accent)', value: 'action' },
					{ title: 'High-Conversion CTA (Accent / Highlight)', value: 'action-cta' },
